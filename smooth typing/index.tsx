...
const settings = definePluginSettings({
    transitionDelay: {
        ...
        description: "Delay entre transiciones (en milisegundos)",
        default: 60,
        onChange: () => applyCSS(),
    },
    animationType: {
    ...
    caretColor: {
        ...
        description: "Color del caret",
        default: 0xffffff,
        component: () => {
            const hex = "#" + ((settings.store.caretColor ?? 0xffffff).toString(16).padStart(6, "0"));
            return (
                <div>
                    <Forms.FormTitle tag="h3">Color del Caret</Forms.FormTitle>
...
export default definePlugin({
    ...
    description: "Añade una aniomacion a la hora de escribir, similar al de vscode y con un caret personalizado",
