...
const settings = definePluginSettings({
    autoStreamProof: {
        ...
        description: "Automaticamente activa el stream proof a la hora de compartir pantalla",
        default: false,
        onChange(value) {
...
const StreamProofButton: ChatBarButtonFactory = ({ isMainChat }) => {
    ...
    const tooltip = active
        ? "StreamProof : Activado — click para desactivar"
        : "StreamProof : Desactivado — click para activar";
...
export default definePlugin({
    name: "Stream proof",
    description: "Oculta mensajes, links, imagenes, etc a la hora de activarlo",
