...
const settings = definePluginSettings({
    ...
    deleteDelay: {
        ...
        description: "Delay en milisegundos antes de eliminar el mensaje original",
        default: 500
    },
...
export default definePlugin({
    name: "Silent edit",
    description: "\"Silenciosamente\" edita un mensaje, mayormente bypassea los messages loggers como el de vencord, desconozco si con otros funciona",
