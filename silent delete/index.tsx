...
const settings = definePluginSettings({
    replacementText: {
        ...
        description: "Texto que se mostrara a la hora de eliminar el mensaje original",
        default: "** **"
    },
    deleteDelay: {
        type: OptionType.NUMBER,
        description: "Delay entre milisegundos antes de eliminar el mensaje",
        default: 200
    },
    ...
    purgeInterval: {
        type: OptionType.NUMBER,
        description: "Delay en milisegundos entre cada eliminación al usar el comando de silentpurge",
        default: 500
    },
    accentColor: {
        type: OptionType.STRING,
        description: "Color del texto e icono del boton de silent delete (en formato hexadecimal, ej: #ed4245)",
        default: "#ed4245"
    }
});
...
export default definePlugin({
    name: "Silent delete",
    description: "\"Silenciosamente\" elimina tus mensajes, mayormente bypassea los messages loggers como el de vencord, desconozco si con otros funciona",
    ...
    commands: [
        {
            name: "silentpurge",
            description: "Silenciosamente elimina tus ultimos mensajes en el canal actual",
            inputType: ApplicationCommandInputType.BUILT_IN,
            options: [{
                name: "Valor",
                description: "El valor de mensajes a eliminar (max 100)",
